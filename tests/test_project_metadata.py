...
class ProjectMetadataTest(unittest.TestCase):
    ...
    def test_amiga_build_uses_native_workbench_gui(self):
        ...
        self.assertIn("TRANSCRIPT_WRAP_WIDTH", source)
        self.assertIn("transcript_append_raw", source)
    ...
    def test_configuration_milestone_is_implemented(self):
        ...
        self.assertIn('DEFAULT_REPLY_MODE "normal"', source)
        self.assertIn("configure_bridge_reply_mode", source)
        ...
        self.assertIn("MODE=normal", makefile)
        self.assertIn("MODE=normal", readme)
        self.assertIn("AmiChatGPT --mode long", package_readme)
